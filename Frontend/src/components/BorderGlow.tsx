...
function parseHSL(hslStr: string): { h: number; s: number; l: number } {
  ...
  if (!match) return { h: 178, s: 100, l: 40 }; // Fallback to Cyan
...
const BorderGlow: React.FC<BorderGlowProps> = ({
  ...
  className = '',
  edgeSensitivity = 30,
  // --- UPDATED COLORS FOR EDUCAITE THEME ---
  glowColor = '178 100 40', // HSL for #00CEC8
  backgroundColor = '#0A0A0A', // Dark theme background
  borderRadius = 32, // Adjusted to match your modal's roundness
  glowRadius = 40,
  glowIntensity = 1.0,
  coneSpread = 25,
  animated = false,
  // Variations of your #00CEC8 theme color for depth
  colors = ['#00CEC8', '#33FFF8', '#008B87'], 
  // -----------------------------------------
  fillOpacity = 0.5,
}) => {
