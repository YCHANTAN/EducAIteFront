  ...
  return (
    <div className="min-h-screen bg-black text-white pt-36 lg:pt-24 pb-10 px-4 md:px-8 lg:px-16 font-sans overflow-x-hidden relative">
        ...
        <div className="bg-[#0A0A0A] border border-white/10 rounded-xl p-3 lg:p-4 flex items-center justify-between gap-3 lg:gap-4 shadow-inner">
          <div className="flex items-center gap-3 lg:gap-4">
            <div className="bg-[#00CEC8]/20 px-2.5 py-1 lg:px-3 lg:py-1.5 rounded-md flex items-center justify-center">
              <span className="text-[#00CEC8] font-bold text-[10px] lg:text-xs">100%</span>
            </div>
      ...
      <motion.div 
        ...
        className="max-w-7xl mx-auto bg-[#0A0A0A] border border-white/10 rounded-2xl lg:rounded-3xl p-5 md:p-8 lg:p-10"
      >
        
        {/* Header Area */}
        <div className="flex justify-between items-start lg:items-center mb-6 lg:mb-8 gap-4">
          <h2 className="text-lg lg:text-xl font-medium text-white/90">
            Pick a certificate that you want to include
          </h2>
          <button onClick={onBack} className="shrink-0 text-[#00CEC8] text-xs lg:text-sm font-bold hover:underline transition-all mt-1 lg:mt-0">
            Go Back
          </button>
        </div>

        {/* Certificate Grid */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6 mb-8 lg:mb-12">
            ...
            return (
              <motion.div
                ...
                className={`relative cursor-pointer rounded-lg overflow-hidden transition-all duration-200 select-none ${
                  isSelected 
                    ? 'border-[2px] lg:border-[3px] border-[#00CEC8] shadow-[0_0_15px_rgba(0,206,200,0.2)]' 
                    : 'border-[2px] lg:border-[3px] border-transparent hover:border-white/10'
                }`}
              >
                <img 
                  ...
                  {isSelected && (
                    ...
                    >
                      <motion.div 
                        ...
                        className="bg-[#00CEC8] rounded-full p-1.5 lg:p-2 shadow-lg"
                      >
                        <svg 
                          xmlns="http://www.w3.org/2000/svg" 
                          className="h-5 w-5 lg:h-8 lg:w-8 text-black" 
                          fill="none" 
                          viewBox="0 0 24 24" 
                          stroke="currentColor" 
                          strokeWidth={3}
        ...
        <div className="flex justify-end w-full lg:w-auto">
          <motion.button 
            ...
            className="w-full lg:w-auto bg-[#00CEC8] text-black font-bold text-base lg:text-lg py-4 px-10 rounded-xl lg:rounded-2xl shadow-[0_4px_20px_rgba(0,206,200,0.3)]"
          >
            Add to Resume
          </motion.button>
        </div>
        ...
        {showPreviewModal && (
          ...
          >
            ...
            <motion.div 
              ...
              className="bg-[#111] border border-white/10 rounded-2xl lg:rounded-3xl w-full max-w-5xl h-full max-h-[95vh] lg:max-h-[90vh] flex flex-col shadow-2xl overflow-hidden relative"
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 md:p-8 flex justify-center bg-black/50 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
                <div className="bg-white w-full max-w-[210mm] min-h-[297mm] shadow-[0_0_50px_rgba(0,0,0,0.5)] p-6 md:p-12 text-black flex flex-col gap-4 md:gap-6 relative mx-auto origin-top">
              ...
              <div className="p-4 lg:p-6 border-t border-white/10 flex flex-col-reverse sm:flex-row justify-end items-stretch sm:items-center gap-3 sm:gap-4 bg-[#0A0A0A]">
                <button 
                  onClick={() => setShowPreviewModal(false)} 
                  className="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-white hover:bg-white/5 transition-all text-sm md:text-base"
                >
                  Keep Editing
                </button>
                
                <button 
                  className="w-full sm:w-auto px-6 py-3 rounded-xl font-bold text-white border border-white/20 hover:bg-white/10 hover:border-white/40 transition-all flex items-center justify-center gap-2 text-sm md:text-base"
                >
                ...
                <button 
                  onClick={onNext} 
                  className="w-full sm:w-auto bg-[#00CEC8] text-black px-8 py-3 rounded-xl font-bold hover:bg-[#00b5b0] hover:scale-[1.02] active:scale-[0.98] transition-all shadow-[0_0_15px_rgba(0,206,200,0.3)] flex items-center justify-center gap-2 text-sm md:text-base"
                >
