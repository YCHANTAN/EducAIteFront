    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 w-full max-w-[1200px] relative z-10">
      ...
      <div className="bg-black border border-white/20 rounded-3xl p-6 flex flex-col justify-between">
        ...
        <div className="flex items-center gap-6">
          ...
          <div>
            ...
            <p className="text-xs text-white/50">You've improved <span className="text-white font-bold">12%</span> since last week</p>
          </div>
        </div>
      </div>
      ...
      <div className="lg:row-span-2 bg-black border border-white/20 rounded-3xl p-8">
        ...
        <div className="space-y-10">
          <div>
            ...
            <p className="text-2xl font-bold text-white mb-4 leading-tight">Programming Language</p>
            <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full bg-[#4A6792]" style={{ width: '80%' }}></div>
            </div>
          ...
          <div>
            ...
            <p className="text-2xl font-bold text-white mb-4 leading-tight">Fundamentals of AI</p>
            <div className="w-full h-2 bg-white/10 rounded-full overflow-hidden">
              <div className="h-full bg-[#4A6792]" style={{ width: '30%' }}></div>
            </div>
            <div className="flex justify-between mt-1 text-[10px] text-white/40"><span>Mastery</span></div>
          </div>
        </div>
      ...
      <div className="bg-black border border-white/20 rounded-3xl p-6">
        ...
        <div className="text-xl text-white font-bold mb-4">
          <span className="text-white">12</span> <span className="text-white/60 font-normal">of 20 completed</span>
        </div>
        <div className="w-full h-3 bg-white/10 rounded-full overflow-hidden mb-3">
          <div className="h-full bg-[#4A6792]" style={{ width: '60%' }}></div>
        </div>
