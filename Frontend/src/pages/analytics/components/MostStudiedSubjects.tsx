...
const MostStudiedSubjects = () => {
  return (
    // 1. The Wrapper: Handles ONLY the Framer Motion entrance animation (Slides from Right)
    <motion.div 
      ...
      className="flex flex-col flex-1" // Moved flex-1 here to maintain grid layout
    >
      {/* 2. The Card: Handles all the visuals, hover states, and CSS transitions */}
      <div className="h-full border border-white/20 rounded-[32px] p-8 flex-1 group hover:border-[#00CEC8]/60 hover:shadow-[0_0_30px_rgba(0,206,200,0.15)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
