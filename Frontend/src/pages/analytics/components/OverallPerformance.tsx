...
const OverallPerformance = () => {
  // Added group, hover border, shadow, translation, and transition to the outer wrapper
  return (
    <div className="border border-white/20 rounded-[32px] p-6 flex flex-col group hover:border-[#00CEC8]/60 hover:shadow-[0_0_30px_rgba(0,206,200,0.15)] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
      ...
      {/* Mini Progress Bars (Added group-hover:bg-[#00CEC8] to the inner bars) */}
