...
const CourseDetails = () => {
  ...
  // --- DYNAMIC STATE: This replaces the static mockFiles ---
  ...
  const handleDeleteFile = (indexToDelete: number) => {
    ...
    setActiveMenuIndex(null); // Close the menu after deleting
  };
    ...
    <>
      <div className={`min-h-screen bg-black text-white p-6 lg:px-16 lg:py-10 font-sans antialiased transition-all duration-500 ${isImportModalOpen ? 'blur-md' : ''}`}>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {/* Mapping over the dynamic 'files' state */}
